...
export const AVAILABLE_FILTERS = [
  { name: 'VespaVelutina', description: 'Nhận diện Ong bắp cày châu Á (Xâm lấn)' },
  { name: 'VespaCrabro', description: 'Nhận diện Ong bắp cày châu Âu' },
  { name: 'VespulaVulgaris', description: 'Nhận diện Ong vàng (Ong chân vàng)' },
  { name: 'HoneybeeDetection', description: 'Theo dõi hoạt động đàn Ong mật' },
  { name: 'IoTSensors', description: 'Đọc dữ liệu cảm biến Nhiệt độ/Độ ẩm' }
];
